...
/**
 * Wallet + transaction-submission provider for the Midnight network. Wraps
 * the testkit-js FluentWalletBuilder so the deploy script can balance, sign,
 * and submit the contract-deployment transaction.
 */

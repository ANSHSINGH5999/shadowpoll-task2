...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.votingCredential) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named votingCredential');
    }
      ...
      voteYes: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('voteYes',
                                     ...
                                     'shadowpoll.compact line 49 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      voteNo: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('voteNo',
                                     'argument 1 (as invoked from Typescript)',
                                     'shadowpoll.compact line 58 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
  ...
  initialState(...args_0) {
    ...
    if (!(id_0.buffer instanceof ArrayBuffer && id_0.BYTES_PER_ELEMENT === 1 && id_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 ...
                                 'shadowpoll.compact line 43 char 1',
                                 'Bytes<32>',
                                 id_0)
    }
  ...
  _votingCredential_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.votingCredential(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('votingCredential',
                                 'return value',
                                 'shadowpoll.compact line 28 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _voteYes_0(context, partialProofData) {
    const credential_0 = this._votingCredential_0(context, partialProofData);
    const nullifier_0 = this._persistentHash_0([credential_0,
    ...
    __compactRuntime.assert(!_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'This credential has already voted');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'shadowpoll.compact line 35 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({
  votingCredential: (...args) => undefined
});
